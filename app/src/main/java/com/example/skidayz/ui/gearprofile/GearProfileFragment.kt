...
import com.example.skidayz.databinding.FragmentGearProfileBinding

class GearProfileFragment : Fragment() {

    private var _binding: FragmentGearProfileBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentGearProfileBinding.inflate(inflater, container, false)
